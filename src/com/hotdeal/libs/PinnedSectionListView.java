...
//		LayoutParams layoutParams = (LayoutParams) pinnedView.getLayoutParams();
		android.view.ViewGroup.LayoutParams layoutParams = (android.view.ViewGroup.LayoutParams) pinnedView.getLayoutParams();
		if (layoutParams == null) {
		    layoutParams = (android.view.ViewGroup.LayoutParams) generateDefaultLayoutParams();
