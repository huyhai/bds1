...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.rgb(113, 190, 15);
	private int underlineColor = Color.rgb(113, 190, 15);
	...
	// private int tabBackgroundResId = Color.MAGENTA;
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				// addIconTab(i, R.drawable.ic_anuong);
				addIconTab(i,
...
//		View view = LayoutInflater.from(HotdealApp.context).inflate(
//				R.layout.about, null);
//		TextView tv = (TextView) view.findViewById(R.id.tvVer);
//		tv.setText(text);
//		return view;
//	}
	...
	private void addTab(final int position, View tab) {
		...
		// tab.setBackgroundResource(R.drawable.ic_anuong);
		tabsContainer
...
//				rectPaint);
		canvas.drawRect(lineLeft, 0, lineRight, height,
				rectPaint);
		...
		canvas.drawRect(0, 0, tabsContainer.getWidth(), underlineHeight,
				rectPaint);
		rectPaint.setColor(Color.rgb(124, 124, 124));
		 canvas.drawRect(0, height - 1,
...
//			tabsContainer.getChildAt(position).setBackgroundColor(Color.RED);
			if (delegatePageListener != null) {
